...
| :--- | :--- | :--- | :--- |
| **[1. ～んがために](#1-んがために-để-nhằm-mục-đích)** | Để nhằm mục đích... | `V-nai (bỏ ない) + んがために`<br>*(する $\rightarrow$ せんがために)* | Quyết tâm cực kỳ cao độ, sẵn sàng hy sinh để đạt được mục tiêu lớn lao ở vế trước. |
...
| **[3. ～べくして](#3-べくして-đương-nhiên-phải-thế)** | Đương nhiên phải thế | `V-ru + べくして + V-ru` | Khẳng định một kết quả xảy ra là hoàn toàn hợp lý, tất yếu vì đã có các nguyên nhân tích lũy từ trước. |
| **[4. ～べくもない](#4-べくもない-làm-sao-có-thể--không-thể)** | Làm sao có thể... / Không thể... | `V-ru + べくもない`<br>*(する $\rightarrow$ すべくもない)* | Lập luận logic chỉ ra việc làm vế trước là hoàn toàn bất khả thi, không thể trông đợi gì được. |
| **[5. ～ともなく](#5-ともなく-không-chủ-định--không-rõ-từ-đâu)** | Vô tình... / Không chủ định | `V-ru + ともなく / ともなしに` | Thực hiện hành động một cách vô thức, không tập trung ý chí (ví dụ: vô tình nhìn, vô tình nghe). |
...
*   **Cấu trúc**: $\text{V}_{\text{nai (bỏ ない)}}$ + **んがために** (Đặc biệt: **する** $\rightarrow$ **せんがために**)
...
*   **Cấu trúc**: $\text{V1}_{\text{ru}}$ + **べくして** + $\text{V1}$ (thường đi với dạng quá khứ ở cuối câu: **～た**)
...
*   **Cấu trúc**: $\text{V}_{\text{ru}}$ + **べくもない** (Đặc biệt: **する** $\rightarrow$ **すべくもない**)
