...
| :--- | :---: | :--- | :--- |
| **まで (Made)** | 6 | `～てまで`, `～ないまでも` | Thể hiện giới hạn cực đoan, điểm dừng của hành động. |
| **もの (Mono)** | 9 | `～ものなら`, `～ものを` | Biểu đạt cảm xúc, giả định, tiếc nuối và phản đối. |
| **こと (Koto)** | 9 | `～ことなしに`, `～ないことには` | Diễn đạt lý do, điều kiện cần, khuyên bảo và cảm thán. |
| **ところ (Tokoro)** | 7 | `～ところを`, `～taところで` | Mô tả bối cảnh thời điểm, nhượng bộ và căn cứ phán đoán. |
| **ばかり (Bakari)** | 5 | `～んばかりに`, `～とばかりに` | Chỉ thái độ thay lời nói, trạng thái suýt diễn ra. |
| **限り (Kagiri)** | 5 | `～を限りに`, `～限りだ` | Giới hạn thời gian kết thúc hoặc mức độ cảm xúc tối đa. |
| **上 (Ue)** | 5 | `～上は`, `～上（じょう）` | Liên quan đến trình tự thực hiện và khía cạnh đánh giá. |
| **次第 (Shidai)** | 3 | `～次第`, `～次第で` | Chỉ sự ưu tiên thời gian và sự phụ thuộc quyết định. |
| **わけ (Wake)** | 4 | `～わけにはいかない`, `～わけがない` | Đưa ra các suy luận logic và ràng buộc lương tâm/xã hội. |
| **なり (Nari)** | 3 | `～なり`, `～なり～なり` | Biểu thị quan hệ tức thì, lựa chọn ví dụ và sự tương thích. |
| **極まり (Kiwamari)** | 4 | `～極まる`, `～の極み` | Đạt đến điểm giới hạn tột cùng của cảm xúc/trạng thái. |
| **Hành động liên tiếp** | 3 | `～が早いか`, `～そばから` | Vừa mới làm xong hành động A thì ngay lập tức hành động B xảy ra. |
| **Nhân tiện / Đi kèm** | 3 | `～gatera`, `～かたわら` | Tiện thể làm việc này thì kết hợp làm luôn việc khác. |
...
| **Mức độ / So sánh** | 5 | `～はおろか`, `～tariとも` | Nhấn mạnh tính chất cực đoan của sự việc, so sánh hoặc giới hạn số lượng. |
...
| **So Sánh (Mono vs Koto)** | - | `Phân biệt Mono - Koto` | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
| **So Sánh (Mono vs Wake)** | - | `Phân biệt Mono - Wake` | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
