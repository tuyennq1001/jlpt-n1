...
| Nhóm Ngữ Pháp | Số Lượng | Mẫu Tiêu Biểu | Liên Kết Tài Liệu | Nội Dung Tóm Tắt |
| :--- | :---: | :--- | :--- | :--- |
| **まで (Made)** | 6 | `～てまで`, `～ないまでも` | [n1_grammar_made.md](./n1_grammar_made.md) | Thể hiện giới hạn cực đoan, điểm dừng của hành động. |
| **もの (Mono)** | 9 | `～ものなら`, `～ものを` | [n1_grammar_mono.md](./n1_grammar_mono.md) | Biểu đạt cảm xúc, giả định, tiếc nuối và phản đối. |
| **こと (Koto)** | 9 | `～ことなしに`, `～ないことには` | [n1_grammar_koto.md](./n1_grammar_koto.md) | Diễn đạt lý do, điều kiện cần, khuyên bảo và cảm thán. |
| **ところ (Tokoro)** | 7 | `～ところを`, `～taところで` | [n1_grammar_tokoro.md](./n1_grammar_tokoro.md) | Mô tả bối cảnh thời điểm, nhượng bộ và căn cứ phán đoán. |
| **ばかり (Bakari)** | 5 | `～んばかりに`, `～とばかりに` | [n1_grammar_bakari.md](./n1_grammar_bakari.md) | Chỉ thái độ thay lời nói, trạng thái suýt diễn ra. |
| **限り (Kagiri)** | 5 | `～を限りに`, `～限りだ` | [n1_grammar_kagiri.md](./n1_grammar_kagiri.md) | Giới hạn thời gian kết thúc hoặc mức độ cảm xúc tối đa. |
| **上 (Ue)** | 5 | `～上は`, `～上（じょう）` | [n1_grammar_ue.md](./n1_grammar_ue.md) | Liên quan đến trình tự thực hiện và khía cạnh đánh giá. |
| **次第 (Shidai)** | 3 | `～次第`, `～次第で` | [n1_grammar_shidai.md](./n1_grammar_shidai.md) | Chỉ sự ưu tiên thời gian và sự phụ thuộc quyết định. |
| **わけ (Wake)** | 4 | `～わけにはいかない`, `～わけがない` | [n1_grammar_wake.md](./n1_grammar_wake.md) | Đưa ra các suy luận logic và ràng buộc lương tâm/xã hội. |
| **なり (Nari)** | 3 | `～なり`, `～なり～なり` | [n1_grammar_nari.md](./n1_grammar_nari.md) | Biểu thị quan hệ tức thì, lựa chọn ví dụ và sự tương thích. |
| **極まり (Kiwamari)** | 4 | `～極まる`, `～の極み` | [n1_grammar_kiwamari.md](./n1_grammar_kiwamari.md) | Đạt đến điểm giới hạn tột cùng của cảm xúc/trạng thái. |
| **Hành động liên tiếp** | 3 | `～が早いか`, `～そばから` | [n1_group_immediate.md](./n1_group_immediate.md) | Vừa mới làm xong hành động A thì ngay lập tức hành động B xảy ra. |
| **Nhân tiện / Đi kèm** | 3 | `～gatera`, `～かたわら` | [n1_group_by_the_way.md](./n1_group_by_the_way.md) | Tiện thể làm việc này thì kết hợp làm luôn việc khác. |
| **Lý do đặc biệt** | 4 | `～とあって`, `～ばこそ` | [n1_group_reason.md](./n1_group_reason.md) | Nhấn mạnh nguyên nhân khách quan, chủ quan hoặc giữ thể diện. |
| **Phủ định / Bắt buộc** | 4 | `～ずにはすまない`, `～てやまない` | [n1_group_negation.md](./n1_group_negation.md) | Diễn tả ý nghĩa buộc phải làm điều gì đó hoặc không kìm nén được cảm xúc. |
| **Phụ thuộc / Điều kiện** | 3 | `～いかん`, `～をおいて` | [n1_group_dependency.md](./n1_group_dependency.md) | Nhấn mạnh mối quan hệ phụ thuộc hoặc điều kiện duy nhất. |
| **Nhượng bộ / Trái ngược** | 7 | `～といえども`, `～思いきや` | [n1_group_concession.md](./n1_group_concession.md) | Diễn tả thực tế tương phản, trái ngược với kỳ vọng hoặc sự nhượng bộ. |
| **Mức độ / So sánh** | 5 | `～はおろか`, `～tariとも` | [n1_group_emphasis.md](./n1_group_emphasis.md) | Nhấn mạnh tính chất cực đoan của sự việc, so sánh hoặc giới hạn số lượng. |
| **Xu hướng / Trạng thái** | 5 | `～めく`, `～きらいがある` | [n1_group_tendency.md](./n1_group_tendency.md) | Miêu tả vẻ bề ngoài, hơi hướng hoặc xu hướng tính cách tiêu cực. |
| **Bỏ qua / Tránh né** | 3 | `～をよそに`, `～なくして（は）` | [n1_group_avoidance.md](./n1_group_avoidance.md) | Thực hiện hành động mà không cần có một yếu tố đi kèm hoặc mặc kệ tác động. |
| **Giới hạn / Thời điểm** | 5 | `～にして`, `～をもって` | [n1_group_scope.md](./n1_group_scope.md) | Xác định mốc thời gian, cơ hội bước ngoặt hoặc phương thức đặc biệt. |
| **Đánh giá / Quan điểm** | 3 | `～からいって`, `～に言わせれば` | [n1_group_perspective.md](./n1_group_perspective.md) | Đưa ra nhận xét, đánh giá hoặc góc nhìn từ một đối tượng, cương vị. |
| **Hướng vào đối tượng** | 4 | `～をめぐって`, `～にこたえて` | [n1_group_attitude.md](./n1_group_attitude.md) | Diễn tả hướng tác động của hành động hoặc thái độ vào một đối tượng. |
| **Cấm đoán / Nghĩa vụ** | 6 | `～べからず`, `～まじき` | [n1_group_advanced_negation.md](./n1_group_advanced_negation.md) | Các dạng phủ định cổ, cấm đoán hoặc khuyên răn mạnh mẽ trên cương vị. |
| **Kính ngữ nâng cao** | 6 | `～おいでになる`, `～まかり出る` | [n1_group_keigo.md](./n1_group_keigo.md) | Kính ngữ cực độ (Cung đình ngữ) và khiêm nhường ngữ cổ trang trọng. |
| **Phó từ & Liên từ** | 8 | `ひいては`, `ましてや` | [n1_group_conjunctions.md](./n1_group_conjunctions.md) | Các liên kết câu học thuật giúp thay đổi hoặc nhấn mạnh lập luận bài viết. |
| **Tương quan đặc biệt** | 5 | `～もさることながら`, `～と相まって` | [n1_group_correlation.md](./n1_group_correlation.md) | Diễn tả sự cộng hưởng giữa 2 yếu tố hoặc đặc tính độc nhất vô nhị. |
| **Trách móc / Lấy cớ** | 4 | `～ともあろうものが`, `～をいいことに` | [n1_group_criticism.md](./n1_group_criticism.md) | Phê phán hành vi xấu, lợi dụng tình huống hoặc trốn tránh trách nhiệm. |
| **Tiến trình & Ý chí cổ** | 5 | `～んがために`, `～んとする` | [n1_group_classical_aspect.md](./n1_group_classical_aspect.md) | Kế thừa văn phong viết cổ để diễn tả mục đích tối cao hoặc trạng thái sắp biến đổi. |
| **So Sánh (Mono vs Koto)** | - | `Phân biệt Mono - Koto` | [n1_grammar_mono_vs_koto.md](./n1_grammar_mono_vs_koto.md) | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
| **So Sánh (Mono vs Wake)** | - | `Phân biệt Mono - Wake` | [n1_grammar_mono_vs_wake.md](./n1_grammar_mono_vs_wake.md) | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
...
---
# Tổng hợp Ngữ pháp JLPT N1 liên quan đến まで (Made)
...
| :--- | :--- | :--- | :--- |
| **[1. ～てまで / ～までして](#1-てまで--までして-đến-mức-phải--làm-cả-việc)** | Đến mức phải... / Làm cả việc... | `V-te + まで`<br>`N + までして` | Chấp nhận làm một việc cực đoan/vượt giới hạn thông thường để đạt mục tiêu. Thường mang tính phê phán hoặc quyết tâm cao độ. |
| **[2. ～ないまでも](#2-ないまでも-dù-không-đến-mức)** | Dù không đến mức... | `V-nai + までも` | Dù không đạt tới mức lý tưởng/cực đoan ở vế trước, thì ít nhất cũng đạt được mức độ ở vế sau. |
| **[3. ～までだ / までのことだ](#3-までだ--までのことだ-cùng-lắm-thì--chỉ-là-thôi)** | Cùng lắm thì... / Chỉ là... thôi | `V-ru + までだ`<br>`V-ta + までだ` | **V-ru**: Cùng lắm chọn cách này (giải pháp cuối).<br>**V-ta**: Chỉ hành động vì nghĩa vụ/tự nhiên chứ không có ý gì khác. |
| **[4. ～までもない](#4-までもない-không-cần-thiết-phải)** | Không cần thiết phải... | `V-ru + までもない` | Việc đã quá rõ ràng hoặc đơn giản, không đáng mất công/thời gian để thực hiện. |
...
| **[6. ～ばそれまでだ](#6-ばそれまでだ-thì-coi-như-xong--mọi-nỗ-lực-cũng-vô-ích)** | Thì coi như xong / Vô ích | `V-ba / V-tara + それまでだ` | Nếu tình huống xấu đó xảy ra thì tất cả nỗ lực, giá trị trước đó đều trở nên vô nghĩa. |
...
*   **Cấu trúc**:
    *   $\text{V}_{\text{nai}}$ + **までも**
    *   Tính từ đuôi い $\rightarrow$ **くないまでも**
    *   Tính từ đuôi な / Danh từ $\rightarrow$ **ではないまでも**
...
#### A. Đi với Động từ thể từ điển ($\text{V}_{\text{ru}}$ + までだ / までのことだ)
...
#### B. Đi với Động từ thể quá khứ ($\text{V}_{\text{ta}}$ + までだ / までのことだ)
...
### 5. ～に至るまで (ni itaru made - Cho đến cả... / Đến tận...)
...
*   **Cấu trúc**:
    *   $\text{V}_{\text{ba}}$ + **それまでだ**
    *   $\text{V}_{\text{tara}}$ + **それまでだ**
...
---
# Tổng hợp Ngữ pháp JLPT N1 liên quan đến こと (Koto)

**こと (Koto)** là một danh từ hình thức dùng để danh từ hóa hành động hoặc sự việc. Ở cấp độ N1, **こと** kết hợp với các trợ từ hoặc trợ động từ cổ/trang trọng để tạo nên các cấu trúc diễn tả nguyên nhân, điều kiện tiên quyết, sự khuyên bảo hoặc cảm thán cao độ.
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～ことなしに](#1-ことなしに-nếu-không-làm-gì-mà-không)** | Nếu không làm gì / Mà không... | `V-ru + ことなしに(は)` | Diễn tả điều kiện bắt buộc phải có để đạt vế sau. Trang trọng, thường dùng trong văn viết. |
| **[2. ～こととて](#2-こととて-vì-do-là)** | Vì... / Do là... | `Thể thông thường + こととて`<br>`N + の + こととて` | Đưa ra lý do khách quan để xin lỗi hoặc mong sự thông cảm (văn phong cổ, trang trọng). |
| **[3. ～ことに](#3-ことに-thật-là-làm-sao-đáng-kinh-ngạc-là)** | Thật là... / Đáng... là | `V-ta / A-i / A-na + ことに` | Biểu thị cảm xúc mạnh mẽ của người nói trước khi trình bày một sự việc. |
| **[4. ～ないことには](#4-ないことには-nếu-không-thì-không)** | Nếu không... thì không... | `V-nai + ことには`<br>`A-i + くないことには` | Vế trước là điều kiện cần thiết, vế sau luôn mang nghĩa phủ định hoặc bất khả thi. |
...
| **[6. ～こともあって](#6-こともあって-cũng-một-phần-vì)** | Cũng một phần vì... | `Thể thông thường + こともあって` | Đưa ra một lý do tiêu biểu trong số nhiều lý do dẫn đến kết quả ở vế sau. |
| **[7. ～ことなく](#7-ことなく-mà-không-hề-không-bị-gián-đoạn)** | Mà không hề... | `V-ru + ことなく` | Hành động diễn ra liên tục, suôn sẻ mà không bị gián đoạn hay gặp trở ngại. (Dạng trang trọng của `～ないで`). |
| **[8. ～ことだ](#8-ことda-nên-khuyên-bảo--thật-là-cảm-thán)** | Nên... (khuyên bảo) / Thật là... | `V-ru/V-nai + ことだ`<br>`A-i/A-na + ことだ` | **Khuyên bảo**: Lời khuyên trực tiếp, nhẹ nhàng.<br>**Cảm thán**: Bày tỏ cảm xúc với tính từ. |
| **[9. ～といったらありはしない](#9-といったらありはしない-cực-kỳ--không-thể-tả-xiết)** | Cực kỳ... / Không thể tả xiết | `A-i / A-na + ことといったらありはしない` | Nhấn mạnh mức độ cực kỳ cao của một trạng thái (thường là tiêu cực hoặc phiền toái). |
...
*   **Cấu trúc**: $\text{V}_{\text{ru}}$ + **ことなしに（は）**
...
*   **Cấu trúc**: 
    *   $\text{Thể thông thường}$ + **こととて** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ の/である)
...
*   **Cấu trúc**: 
    *   $\text{V}_{\text{ta}}$ + **ことに**
    *   $\text{A}_{\text{i}}$ / $\text{A}_{\text{na}}$ + **ことに** (Tính từ な $\rightarrow$ な)
...
*   **Cấu trúc**: 
    *   $\text{V}_{\text{nai}}$ + **ことには**
    *   $\text{A}_{\text{i}}$ $\rightarrow$ **くないことには**
    *   $\text{A}_{\text{na}}$ / $\text{N}$ $\rightarrow$ **でないことには**
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **こともあって** (Tính từ な $\rightarrow$ な, Danh từ $\rightarrow$ の)
...
#### A. Khuyên bảo ($\text{V}_{\text{ru}}$ / $\text{V}_{\text{nai}}$ + ことだ)
...
#### B. Cảm thán ($\text{A}_{\text{i}}$ / $\text{A}_{\text{na}}$ + ことだ)
...
*   **Cấu trúc**: 
    *   $\text{A}_{\text{i}}$ + **ことといったらありはしない** (hoặc **ことといったらない**)
    *   $\text{A}_{\text{na}}$ + **（な）ことといったらありはしない**
...
---
# Tổng hợp Ngữ pháp JLPT N1 liên quan đến ばかり (Bakari)

Từ gốc **ばかり (Bakari)** ở cấp độ cơ bản mang ý nghĩa "chỉ" hoặc "vừa mới". Tuy nhiên, ở cấp độ N1/N2, nó được biến đổi qua các cấu trúc nâng cao để thể hiện thái độ thay cho lời nói, trạng thái suýt xảy ra, hoặc một nguyên nhân dẫn đến kết quả đáng tiếc.
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～んばかりに](#1-んばかりに--んばかりの-như-thể-sắp-đến-nơi)** | Như thể sắp... đến nơi | `V-nai (bỏ ない) + んばかりに`<br>*(する $\rightarrow$ せんばかりに)* | Miêu tả một trạng thái cực đoan suýt xảy ra (thực tế chưa xảy ra nhưng biểu hiện bên ngoài cực kỳ giống). |
| **[2. ～とばかりに](#2-とばかりに-như-muốn-nói-rằng)** | Như muốn nói rằng... | `Câu trích dẫn (thông thường) + とばかりに` | Diễn tả hành động, thái độ của ai đó nhằm phát ra một thông điệp thay cho lời nói trực tiếp. |
| **[3. ～ばかりに](#3-ばかりに-chỉ-vì)** | Chỉ vì... (kết quả xấu) | `Thể thông thường + ばかりに`<br>`Tính từ な $\rightarrow$ な/である`<br>`N $\rightarrow$ である` | Nêu ra nguyên nhân duy nhất hoặc nhỏ nhặt dẫn đến một kết quả cực kỳ tồi tệ kèm theo sự hối hận. |
| **[4. ～ばかりか](#4-ばかりか--ばかりでなく-không-chỉ-mà-còn)** | Không chỉ... mà còn... | `Thể thông thường + ばかりか`<br>`Tính từ な $\rightarrow$ な / である`<br>`N $\rightarrow$ N / である` | Vế sau bổ sung thêm thông tin có mức độ cao hơn, mang tính bất ngờ hoặc nghiêm trọng hơn. |
| **[5. ～ばかりだ](#5-ばかりだ-cứ-ngày-càng-chiều-hướng-xấu)** | Cứ ngày càng... (chiều hướng xấu) | `V-ru + ばかりだ` | Diễn tả một sự biến đổi đang tiếp diễn liên tục và thường là theo chiều hướng tiêu cực. |
...
*   **Cấu trúc**: $\text{Câu trích dẫn (thông thường)}$ + **とばかりに**
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **ばかりに** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ である)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **ばかりか** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ N / である)
...
---
# Tổng hợp Ngữ pháp JLPT N1 liên quan đến 限り (Kagiri)

Họ ngữ pháp liên quan đến **限り (Kagiri)** (Hán tự: **Hạn - 限**) dùng để biểu thị các giới hạn về mặt thời gian, điều kiện hoặc nhấn mạnh mức độ cao nhất của cảm xúc. Việc nắm vững các cấu trúc này giúp bạn phân biệt rõ ràng các loại "giới hạn" khác nhau trong bài thi N1.
...
| **[3. ～限り（は）](#3-限りは-chừng-nào-còn-thì-vẫn)** | Chừng nào còn... thì vẫn... | `Thể thông thường + 限り（は）`<br>`Tính từ な $\rightarrow$ な/である`<br>`N $\rightarrow$ である` | Diễn tả một điều kiện tiếp diễn: Nếu tình trạng vế trước còn duy trì thì vế sau vẫn tiếp tục. |
| **[4. ～ない限り](#4-ない限り-trừ-khi--nếu-không-thì-không)** | Trừ khi... / Nếu không... | `V-nai + 限り` | Diễn tả điều kiện bắt buộc: Nếu hành động vế trước không xảy ra thì vế sau cũng không thể thực hiện. |
| **[5. ～限りでは](#5-限りでは-trong-phạm-vi-những-gì)** | Trong phạm vi (những gì)... | `V-ru / V-ta + 限りでは` | Giới hạn nguồn thông tin mà người nói dùng để đưa ra nhận định hoặc phán đoán của mình. |
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **限り（は）** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ である)
...
*   **Cấu trúc**: $\text{V}_{\text{nai}}$ + **限り** (Tính từ な $\rightarrow$ でない/である, Danh từ $\rightarrow$ でない/である)
...
*   **Cấu trúc**: $\text{V}_{\text{ru}} / \text{V}_{\text{ta}}$ + **限りでは**
...
---
# Tổng hợp Ngữ pháp JLPT N1 liên quan đến わけ (Wake)

Từ gốc **わけ (Wake)** (Hán tự: **Dịch - 訳**) mang nghĩa là "lý do, ý nghĩa, nguyên nhân hợp logic". Trong ngữ pháp trung và cao cấp, các cấu trúc đi với **わけ** giúp người nói biểu đạt sự suy luận logic, phủ định một phần hoặc đưa ra những ràng buộc mang tính đạo đức và xã hội.
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～わけにはいかない](#1-わけにはいかない-không-thể-làm-vì-đạo-đứcpháp-luật)** | Không thể làm... (vì đạo đức/pháp luật) | `V-ru + わけにはいかない`<br>`V-nai + わけにはいかない` | **V-ru**: Không thể làm vì lương tâm/bổn phận không cho phép.<br>**V-nai (phủ định kép)**: Buộc phải làm vì nghĩa vụ. |
| **[2. ～わけがない](#2-わけがない--わけはない-tuyệt-đối-không-thể-làm-sao-mà)** | Tuyệt đối không thể... / Làm sao mà... | `Thể thông thường + わけがない`<br>`Tính từ な $\rightarrow$ な / である`<br>`N $\rightarrow$ の / である` | Phủ định mạnh mẽ dựa trên lập luận khoa học, logic hoặc thực tế hiển nhiên. |
| **[3. ～わけではない](#3-わけではない--わけ regiments-không-hẳn-là-không-có-nghĩa-là)** | Không hẳn là... / Không có nghĩa là... | `Thể thông thường + わけではない`<br>`Tính từ な $\rightarrow$ な / である`<br>`N $\rightarrow$ な / である / の` | Phủ định một phần tình huống, tránh đưa ra kết luận phiến diện hoặc tuyệt đối hóa. |
| **[4. ～わけだ](#4-わけだ-thảo-nào--hóa-ra-là--đương-nhiên-là)** | Thảo nào... / Đương nhiên là... | `Thể thông thường + わけだ`<br>`Tính từ な $\rightarrow$ な / である`<br>`N $\rightarrow$ な / である / の` | Đưa ra kết luận mang tính hiển nhiên, giải thích nguyên nhân logic của một sự việc đã biết. |
...
#### A. Dạng khẳng định ($\text{V}_{\text{ru}}$ + わけにはいかない)
...
#### B. Dạng phủ định kép ($\text{V}_{\text{nai}}$ + わけにはいかない)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **わけがない** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ の/である)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **わけではない** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ な/である/の)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **わけだ** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ な/である/の)
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～とあって](#1-とあって-vì-tình-huống-đặc-biệt)** | Vì tình huống đặc biệt... nên... | `Thể thông thường + とあって`<br>`Tính từ な/N (bỏ だ) + とあって` | Nêu ra một lý do khác thường (lễ hội, sự kiện đặc biệt) dẫn đến kết quả tất yếu vế sau. |
| **[2. ～ばこそ](#2-ばこそ-chính-vì-nên-mới)** | Chính vì... nên mới... | `V-ba + こそ`<br>`Tính từ / N + であれ + こそ` | Nhấn mạnh lý do sâu sắc mang tính cảm xúc (yêu thương, quan tâm, trách nhiệm). |
| **[3. ～ゆえ（に）](#3-ゆえに-bởi-vì--do)** | Bởi vì... / Do... | `Thể thông thường + ゆえ（に）`<br>`Tính từ な $\rightarrow$ な/である`<br>`N $\rightarrow$ の/である` | Văn phong cổ, trang trọng. Thường dùng trong văn viết, thư từ, sách báo lịch sự. |
| **[4. ～てまえ](#4-てまえ-chính-vì-tình-thế-đó-nên-phải)** | Chính vì tình thế đó... nên phải... | `V-ru / V-ta + てまえ`<br>`N + のてまえ` | Diễn tả ý nghĩa: Do đã nói, hứa hoặc đứng trước một vị thế xã hội nên buộc phải làm, nếu không sẽ mất thể diện/xấu hổ. |
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **とあって** (Tính từ な và Danh từ không đi với だ)
...
*   **Cấu trúc**: 
    *   $\text{V}_{\text{ba}}$ + **こそ**
    *   $\text{A}_{\text{i}}$ $\rightarrow$ **ければこそ**
    *   $\text{A}_{\text{na}} / \text{N}$ $\rightarrow$ **であればこそ**
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **ゆえ（に）** (Tính từ な $\rightarrow$ な/である, Danh từ $\rightarrow$ の/である)
...
*   **Cấu trúc**: $\text{V}_{\text{ru}} / \text{V}_{\text{ta}}$ + **てまえ** / $\text{N}$ + **のてまえ**
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～といえども](#1-といえども-dù-nói-thế-đi-chăng-nữa)** | Dù nói thế đi chăng nữa... | `Thể thông thường + といえども`<br>`N + といえども` | Khẳng định ngay cả trường hợp đặc biệt ở vế trước thì thực tế vế sau vẫn đúng. Văn phong trang trọng. |
| **[2. ～思いきや](#2-思いきや-cứ-nghĩ-là-ai-ngờ)** | Cứ nghĩ là... ai ngờ... | `Thể thông thường + と思いきや` | Thể hiện sự ngạc nhiên tột độ của người nói trước một kết quả hoàn toàn trái ngược với suy đoán ban đầu. |
| **[3. ～とはいえ](#3-とはいえ-mặc-dù-rằng-tuy-nói-thế-nhưng)** | Mặc dù là... / Tuy nói thế nhưng... | `Thể thông thường + とは言え`<br>`N + とは言え` | Thừa nhận thực tế ở vế trước, nhưng vế sau lại đưa ra nhận định hoặc thực tế có mức độ khác đi. |
| **[4. ～ながらも](#4-ながらも-tuy-nhưng-mặc-dù)** | Tuy... nhưng... / Mặc dù... | `V-masu (bỏ ます) + ながらも`<br>`Tính từ / N + ながらも` | Thường đi với các từ chỉ trạng thái trái ngược (tiêu cực - tích cực). Sắc thái khá trang trọng. |
| **[5. ～つつも](#5-つつも-dù-biết-nhưng-vẫn)** | Dù biết là... nhưng vẫn... | `V-masu (bỏ ます) + つつも` | Vế trước là nhận thức, vế sau là hành động mâu thuẫn với nhận thức đó (thường mang tính tự trách, hối hận). |
| **[6. ～ものの](#6-ものの-mặc-dù-nhưng)** | Mặc dù... nhưng... | `Thể thông thường + ものの` | Diễn tả thực tế tương phản nhẹ nhàng (tương tự như が hay けれど nhưng trang trọng hơn). |
| **[7. ～からといって](#7-からといって-không-phải-cứ-thì)** | Không phải cứ... thì... | `Thể thông thường + からといって` | Bác bỏ lập luận phiến diện: Cứ có lý do ở vế trước thì đương nhiên có kết quả vế sau. |
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **といえども** (Tính từ な và Danh từ thường không đi với だ)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **と思いきや**
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **とは言え** (Tính từ な và Danh từ không đi với だ)
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **ものの**
...
*   **Cấu trúc**: $\text{Thể thông thường}$ + **からといって**
...
| Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :--- | :--- | :--- | :--- |
| **[1. ～べからず / ～べからざる](#1-べからず--べからざる-không-được-phép)** | Không được phép... | `V-ru + べからず / べからざる`<br>*(する $\rightarrow$ すべからず)* | **べからず**: Cấm đoán trên biển hiệu, nội quy.<br>**べからざる**: Đi trước danh từ để chỉ việc cấm kỵ. |
| **[2. ～まじき](#2-まじき-không-thể-chấp-nhận-đối-với)** | Không thể chấp nhận đối với... | `V-ru + まじき + N`<br>*(する $\rightarrow$ するまじき)* | Đứng trước danh từ chỉ hành vi hoặc thái độ không được phép có ở một cương vị xã hội cụ thể. |
| **[3. ～ずにはおかない](#3-ずにはおかない-nhất-định-phải--chắc-chắn-sẽ)** | Nhất định phải... / Chắc chắn sẽ... | `V-nai (bỏ ない) + ずにはおかない`<br>*(する $\rightarrow$ せずにはおかない)* | **① Ý chí**: Quyết tâm làm bằng được.<br>**② Tự nhiên**: Trạng thái chắc chắn sẽ xảy ra. |
| **[4. ～にかたくない](#4-にかたくない-không-khó-để-tưởng-tượngsuy-đoán)** | Không khó để... | `V-ru / N + にかたくない` | Thường đi với các động từ: 想像する (tưởng tượng), 察する (cảm thông/đoán), 理解する (hiểu). |
| **[5. ～にたえない](#5-にたえない-vô-cùng-cảm-xúc--không-thể-chịu-nổi)** | Vô cùng (cảm xúc) / Không thể... | `V-ru / N + にたえない` | **① Cảm xúc**: Vô cùng cảm kích, hối tiếc...<br>**② Chịu đựng**: Không thể ngửi nổi tai/mắt (đọc, nghe). |
| **[6. ～に足る](#6-に足る-đáng-để--đủ-điều-kiện-để)** | Đáng để... / Đủ điều kiện để... | `V-ru / N + に足る` | Khẳng định đối tượng có đủ giá trị hoặc tư cách để nhận hành động phía trước (tin tưởng, tôn kính). |
...
*   **Cấu trúc**: $\text{V}_{\text{ru}}$ + **べからず / べからざる** (Đặc biệt: **する** $\rightarrow$ **すべからず / すべからざる**)
...
*   **Cấu trúc**: $\text{V}_{\text{ru}}$ + **まじき** + $\text{N}$ (Đặc biệt: **する** $\rightarrow$ **するまじき / すまじき**)
...
*   **Cấu trúc**: $\text{V}_{\text{nai (bỏ ない)}}$ + **ずにはおかない** (Đặc biệt: **する** $\rightarrow$ **せずにはおかない**)
*   **Ý nghĩa**:
...
*   **Cấu trúc**: $\text{V}_{\text{ru}} / \text{N}$ + **にかたくない**
...
*   **Cấu trúc**: $\text{V}_{\text{ru}} / \text{N}$ + **にたえない**
*   **Ý nghĩa**:
...
*   **Cấu trúc**: $\text{V}_{\text{ru}} / \text{N}$ + **に足る**
...
---
# So Sánh Ý Nghĩa & Sắc Thái Giữa Ngữ Pháp Hệ もの (Mono) và わけ (Wake)
...
| Đặc tính | Ngữ pháp hệ **もの (Mono)** | Ngữ pháp hệ **わけ (Wake)** |
| :--- | :--- | :--- |
...
*   **～わけだ (Thảo nào / Kết luận logic):**
    ...
    *   *Cách dùng:* Rút ra kết luận tất yếu từ một nguyên nhân thực tế đã được nêu ra từ trước (Nguyên nhân $\rightarrow$ Kết quả logic).
    *   *Ví dụ:*
        *   エアコンが消えている。暑い**わけだ**。
