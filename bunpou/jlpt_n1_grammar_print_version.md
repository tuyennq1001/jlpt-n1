...
# 📚 Kho Tài Liệu Ôn Luyện JLPT N1 (Ngữ Pháp & Từ Vựng)

Chào mừng bạn đến với kho tài liệu ôn luyện **JLPT N1**. Để thuận tiện cho việc học tập, kho lưu trữ đã được chia làm 2 mục chính:

1. **📚 Ngữ pháp (`bunpou/`):** Tổng hợp ngữ pháp nâng cao được nhóm lại theo từ gốc hoặc ý nghĩa để dễ dàng so sánh, đối chiếu.
...
* 👉 **[Ghi chú trực quan: Từ láy tượng hình & Phó từ](./goi/goi_onomatopoeia.md)** (Chứa 8 từ vựng cơ bản phân nhóm kèm ảnh minh họa AI).

---

## 📂 2. Tài Liệu Ngữ Pháp (Bunpou)

Dưới đây là danh sách các file chi tiết của từng nhóm ngữ pháp. Mỗi file đều có bảng so sánh sắc thái kết nối, giải thích ngữ nghĩa và các ví dụ tiếng Nhật đi kèm dịch nghĩa tiếng Việt.

| # | Nhóm Ngữ Pháp | Số Lượng | Mẫu Tiêu Biểu | Nội Dung Tóm Tắt |
| :---: | :--- | :---: | :--- | :--- |
| 1 | **まで** | 6 | `～てまで`, `～ないまでも` | Thể hiện giới hạn cực đoan, điểm dừng của hành động. |
| 2 | **もの** | 9 | `～ものなら`, `～ものを` | Biểu đạt cảm xúc, giả định, tiếc nuối và phản đối. |
| 3 | **こと** | 9 | `～ことなしに`, `～ないことには` | Diễn đạt lý do, điều kiện cần, khuyên bảo và cảm thán. |
| 4 | **ところ** | 7 | `～ところを`, `～たところで` | Mô tả bối cảnh thời điểm, nhượng bộ và căn cứ phán đoán. |
| 5 | **ばかり** | 5 | `～んばかりに`, `～とばかりに` | Chỉ thái độ thay lời nói, trạng thái suýt diễn ra. |
| 6 | **限り** | 5 | `～を限りに`, `～限りだ` | Giới hạn thời gian kết thúc hoặc mức độ cảm xúc tối đa. |
| 7 | **上** | 5 | `～上は`, `～上（じょう）` | Liên quan đến trình tự thực hiện và khía cạnh đánh giá. |
| 8 | **次第** | 3 | `～次第`, `～次第で` | Chỉ sự ưu tiên thời gian và sự phụ thuộc quyết định. |
| 9 | **わけ** | 4 | `～わけにはいかない`, `～わけがない` | Đưa ra các suy luận logic và ràng buộc lương tâm/xã hội. |
| 10 | **なり** | 3 | `～なり`, `～なり～なり` | Biểu thị quan hệ tức thì, lựa chọn ví dụ và sự tương thích. |
| 11 | **極まり** | 4 | `～極まる`, `～の極み` | Đạt đến điểm giới hạn tột cùng của cảm xúc/trạng thái. |
| 12 | **Hành động liên tiếp** | 3 | `～が早いか`, `～そばから` | Vừa mới làm xong hành động A thì ngay lập tức hành động B xảy ra. |
| 13 | **Nhân tiện / Đi kèm** | 3 | `～がてら`, `～かたわら` | Tiện thể làm việc này thì kết hợp làm luôn việc khác. |
| 14 | **Lý do đặc biệt** | 4 | `～とあって`, `～ばこそ` | Nhấn mạnh nguyên nhân khách quan, chủ quan hoặc giữ thể diện. |
| 15 | **Phủ định / Bắt buộc** | 4 | `～ずにはすまない`, `～てやまない` | Diễn tả ý nghĩa buộc phải làm điều gì đó hoặc không kìm nén được cảm xúc. |
| 16 | **Phụ thuộc / Điều kiện** | 3 | `～いかん`, `～をおいて` | Nhấn mạnh mối quan hệ phụ thuộc hoặc điều kiện duy nhất. |
| 17 | **Nhượng bộ / Trái ngược** | 7 | `～といえども`, `～思いきや` | Diễn tả thực tế tương phản, trái ngược với kỳ vọng hoặc sự nhượng bộ. |
| 18 | **Mức độ / So sánh** | 5 | `～はおろか`, `～たりとも` | Nhấn mạnh tính chất cực đoan của sự việc, so sánh hoặc giới hạn số lượng. |
| 19 | **Xu hướng / Trạng thái** | 5 | `～めく`, `～きらいがある` | Miêu tả vẻ bề ngoài, hơi hướng hoặc xu hướng tính cách tiêu cực. |
| 20 | **Bỏ qua / Tránh né** | 3 | `～をよそに`, `～なくして（は）` | Thực hiện hành động mà không cần có một yếu tố đi kèm hoặc mặc kệ tác động. |
| 21 | **Giới hạn / Thời điểm** | 5 | `～にして`, `～をもって` | Xác định mốc thời gian, cơ hội bước ngoặt hoặc phương thức đặc biệt. |
| 22 | **Đánh giá / Quan điểm** | 3 | `～からいって`, `～に言わせれば` | Đưa ra nhận xét, đánh giá hoặc góc nhìn từ một đối tượng, cương vị. |
| 23 | **Hướng vào đối tượng** | 4 | `～をめぐって`, `～にこたえて` | Diễn tả hướng tác động của hành động hoặc thái độ vào một đối tượng. |
| 24 | **Cấm đoán / Nghĩa vụ** | 6 | `～べからず`, `～まじき`, `～にたえない` | Các dạng phủ định cổ, cấm đoán hoặc khuyên răn mạnh mẽ trên cương vị. |
| 25 | **Kính ngữ nâng cao** | 6 | `～おいでになる`, `～まかり出る` | Kính ngữ cực độ (Cung đình ngữ) và khiêm nhường ngữ cổ trang trọng. |
| 26 | **Phó từ & Liên từ** | 8 | `ひいては`, `ましてや` | Các liên kết câu học thuật giúp thay đổi hoặc nhấn mạnh lập luận bài viết. |
| 27 | **Tương quan đặc biệt** | 5 | `～もさることながら`, `～と相まって` | Diễn tả sự cộng hưởng giữa 2 yếu tố hoặc đặc tính độc nhất vô nhị. |
| 28 | **Trách móc / Lấy cớ** | 4 | `～ともあろうものが`, `～をいいことに` | Phê phán hành vi xấu, lợi dụng tình huống hoặc trốn tránh trách nhiệm. |
| 29 | **Tiến trình & Ý chí cổ** | 5 | `～んがために`, `～んとする` | Kế thừa văn phong viết cổ để diễn tả mục đích tối cao hoặc trạng thái sắp biến đổi. |
| 30 | **So Sánh (もの vs こと)** | - | `Phân biệt もの - こと` | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
| 31 | **So Sánh (もの vs わけ)** | - | `Phân biệt もの - わけ` | Phân biệt chi tiết cách dùng và sắc thái giữa hai hệ ngữ pháp. |
| - | **Tất cả ngữ pháp (Bản in)** | - | `In ấn` | Bản tổng hợp tất cả các mẫu ngữ pháp để in ấn hoặc học liền mạch. |
...
|  6  | **[～ばそれまでだ](#6-ばそれまでだ-thì-coi-như-xong--mọi-nỗ-lực-cũng-vô-ích)** | Thì coi như xong / Vô ích        | `V-ば / V-たら + それまでだ`      | Nếu tình huống xấu đó xảy ra thì tất cả nỗ lực, giá trị trước đó đều trở nên vô nghĩa.                                       |
|     |                                                                   |                                  |                            |                                                                                                                              |
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ものを** (A-な → な, N → である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ものがある** (A-な → な)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **というものだ** (Không dùng だ của tính từ な và danh từ)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ものか** (A-な → な, N → な/である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ものの** (A-な → な/である, N → である)
...
*   **Cấu trúc**: 
    *   V-る・A-い・A-な・N + **こととて** (A-な → な/である, N → の/である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **こともあって** (A-な → な, N → の)
...
*   **Cấu trúc**: 
    *   A-い + **ことといったらありはしない** (hoặc **ことといったらない**)
    *   A-な + **（な）ことといったらありはしない**
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ばかりに** (A-な → な/である, N → である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ばかりか** (A-な → な/である, N → N / である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **限り（は）** (A-な → な/である, N → である)
...
*   **Cấu trúc**: V-ない + **限り** (A-な → でない/である, N → でない/である)
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 47 | **[～次第 (Ngay sau khi)](#1-次第-ngay-sau-khi)** | Ngay sau khi... | `V-ます (bỏ ます) + 次第` | Hứa hẹn thực hiện một hành động có chủ ý ngay sau khi một sự việc khác hoàn thành. |
| 48 | **[～次第だ / ～次第で](#2-次第だ--次第で-tùy-thuộc-vào)** | Tùy thuộc vào... | `N + 次第だ / 次第で` | Diễn tả ý nghĩa: Kết quả vế sau biến đổi hoặc được quyết định bởi yếu tố ở vế trước. |
| 49 | **[～次第だ (Cuối câu)](#3-次第だ-cuối-câu-giải-thích-sự-tình)** | Do đó... / Vì sự tình đó... | `V-る・A-い・A-な・N + 次第だ` | Dùng để giải thích tiến trình, lý do dẫn đến tình trạng hiện tại trong văn viết trang trọng. |
|  |
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **次第だ** (A-な → な/である, N → の/である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **わけがない** (A-な → な/である, N → の/である)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **わけではない** (A-な → な/である, N → な/である/の)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **わけだ** (A-な → な/である, N → な/である/の)
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 54 | **[～なり (Ngay sau khi)](#1-なり-ngay-sau-khi)** | Ngay sau khi... / Vừa mới... | `V-る + なり` | Diễn tả hành động xảy ra gần như đồng thời. Vế sau là một hành động bất ngờ hoặc không có dự tính trước. |
| 55 | **[～なり～なり](#2-なりなり-hoặc-là-hoặc-là)** | Hoặc là... hoặc là... | `N / V-る + なり + N / V-る + なり` | Đưa ra một vài lựa chọn điển hình có cùng tính chất để người nghe tham khảo hoặc quyết định. |
| 56 | **[～なりに / ～なりの](#3-なりに--なりの-theo- cách-của--tương-xứng-với)** | Theo cách của... / Tương xứng với... | `V-る・A-い・A-な・N + なりに / なりの`<br>`A-な (bỏ だ) + なりに`<br>`N + なりに` | Thừa nhận thực tế: Dù không hoàn hảo nhưng nỗ lực hoặc kết quả đó là phù hợp và chấp nhận được đối với vị thế/năng lực của đối tượng. |
|  |
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **なりに / なりの** (A-な → bỏ だ/である, N → Danh từ)
...
*   **Cấu trúc**: N + **の至り** (N chỉ cảm xúc hoặc tình trạng tinh thần)
...
| Tiêu chí | ～極まる | ～極まりない |
| :--- | :--- | :--- |
| **Cách kết hợp** | Chỉ đi với **A-な (bỏ だ)**.<br>*(Ví dụ: 危険極まる, 失礼極まる)* | Kết hợp linh hoạt hơn:<br>1. **A-な (bỏ だ)** + 極まりない *(Ví dụ: 失礼極まりない)*<br>2. **A-な + なこと** + 極まりない *(Ví dụ: 失礼なこと極まりない)*<br>3. **A-い + こと** + 極まりない *(Ví dụ: うるさいこと極まりない)* |
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 67 | **[～とあって](#1-とあって-vì-tình-huống-đặc-biệt)** | Vì tình huống đặc biệt... nên... | `V-る・A-い・A-な・N + とあって`<br>`A-な/N (bỏ だ) + とあって` | Nêu ra một lý do khác thường (lễ hội, sự kiện đặc biệt) dẫn đến kết quả tất yếu vế sau. |
| 68 | **[～ばこそ](#2-ばこそ-chính-vì-nên-mới)** | Chính vì... nên mới... | `V-ば + こそ`<br>`A / N + であれ + こそ` | Nhấn mạnh lý do sâu sắc mang tính cảm xúc (yêu thương, quan tâm, trách nhiệm). |
| 69 | **[～ゆえ（に）](#3-ゆえに-bởi-vì--do)** | Bởi vì... / Do... | `V-る・A-い・A-な・N + ゆえ（に）`<br>`A-な → な/である`<br>`N → の/である` | Văn phong cổ, trang trọng. Thường dùng trong văn viết, thư từ, sách báo lịch sự. |
| 70 | **[～てまえ](#4-てまえ-chính-vì-tình-thế-đó-nên-phải)** | Chính vì tình thế đó... nên phải... | `V-る / V-た + てまえ`<br>`N + のてまえ` | Diễn tả ý nghĩa: Do đã nói, hứa hoặc đứng trước một vị thế xã hội nên buộc phải làm, nếu không sẽ mất thể diện/xấu hổ. |
|  |
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **とあって** (A-な và N không đi với だ)
...
*   **Cấu trúc**: V-る・A-い・A-な・N + **ゆえ（に）** (A-な → な/である, N → の/である)
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 103 | **[～からいって](#1-からいって--からいうと-xét-về-mặt--nhìn-từ)** | Xét về mặt... / Nhìn từ... | `N + からいって / からいうと` | Đưa ra nhận xét dựa trên một khía cạnh, khía cạnh cụ thể (năng lực, tính cách, số liệu). |
| 104 | **[～から見ると](#2-から見ると--から見れば-nhìn-từ-góc-độ-của)** | Nhìn từ góc độ của... | `N + から見ると / から見れば` | Thể hiện quan điểm, nhận định của một đối tượng cụ thể (cha mẹ, người nước ngoài, chuyên gia) đối với sự việc. |
| 105 | **[～に言わせれば](#3-に言わせれば-nếu-để-ai-đó-nói-thì)** | Nếu để (ai đó) nói thì... | `N + に言わせれば` | Đưa ra ý kiến cá nhân mang tính phản bác, chê trách hoặc đi ngược lại nhận định của số đông. |
|  |
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 110 | **[～べからず / ～べからざる](#1-べからず--べからざる-không-được-phép)** | Không được phép... | `V-る + べからず / べからざる`<br>*(する → すべからず)* | **べからず**: Cấm đoán trên biển hiệu, nội quy.<br>**べからざる**: Đi trước danh từ để chỉ việc cấm kỵ. |
| 111 | **[～まじき](#2-まじき-không-thể-chấp-nhận-đối-với)** | Không thể chấp nhận đối với... | `V-る + まじき + N`<br>*(する → するまじき)* | Đứng trước danh từ chỉ hành vi hoặc thái độ không được phép có ở một cương vị xã hội cụ thể. |
| 112 | **[～ずにはおかない](#3-ずにはおかない-nhất-định-phải--chắc-chắn-sẽ)** | Nhất định phải... / Chắc chắn sẽ... | `V-ない (bỏ ない) + ずにはおかない`<br>*(する → せずにはおかない)* | **① Ý chí**: Quyết tâm làm bằng được.<br>**② Tự nhiên**: Trạng thái chắc chắn sẽ xảy ra. |
| 113 | **[～にかたくない](#4-にかたくない-không-khó-để-tưởng-tượngsuy-đoán)** | Không khó để... | `V-る / N + にかたくない` | Thường đi với các động từ: 想像する (tưởng tượng), 察する (cảm thông/đoán), 理解する (hiểu). |
| 114 | **[～にたえない](#5-にたえない-vô-cùng-cảm-xúc--không-thể-chịu-nổi)** | Vô cùng (cảm xúc) / Không thể... | `V-る / N + にたえない` | **① Cảm xúc**: Vô cùng cảm kích, hối tiếc...<br>**② Chịu đựng**: Không thể ngửi nổi tai/mắt (đọc, nghe). |
| 115 | **[～に足る](#6-に足る-đáng-để--đủ-điều-kiện-để)** | Đáng để... / Đủ điều kiện để... | `V-る / N + に足る` | Khẳng định đối tượng có đủ giá trị hoặc tư cách để nhận hành động phía trước (tin tưởng, tôn kính). |
|  |
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 116 | **[～おいでになる](#1-おいでになる-kính-ngữ-của-いる-行く-来る-ている)** | Kính ngữ của いる, 行く, 来る, ている | `N + (で) + おいでになる`<br>`V-て + おいでになる` | Dùng để tôn kính hành động đang ở, đi, đến hoặc đang thực hiện một việc gì đó của đối phương. |
| 117 | **[～まかり出る](#2-まかり出る-khiêm-nhường-ngữ-của-xuất-hiện-đi-ra)** | Khiêm nhường của "xuất hiện/đi ra" | `まかり + Động từ (出る, 間違える...)` | **まかり** là tiền tố cổ thể hiện sự khiêm nhường cực độ của bản thân khi đi ra hoặc thực hiện hành động trước mặt cấp trên. |
| 118 | **[～遊ばす](#3-遊ばす-tôn-kính-ngực-cực-độ-thay-cho-する)** | Kính ngữ cực độ thay cho する | `N + あそばす`<br>`お/ご + V-ます + あそばす` | Tôn kính ngữ cực độ (Cung đình ngữ), dùng để nói về hành động của những người có địa vị vô cùng cao quý. |
| 119 | **[～にあらせられる](#4-にあらせられる-tôn-kính-cực-độ-thay-cho-でいらっしゃる)** | Tôn kính cực độ thay cho でいらっしゃる | `N + にあらせられる` | Tôn kính ngữ cao nhất trong tiếng Nhật cổ và hiện đại, chỉ dùng cho Hoàng gia, Thiên hoàng hoặc Thần thánh. |
| 120 | **[～て差し上げる](#5-て差し上げる-khiêm-nhường-của-làm-cho-ai-đó-việc-gì)** | Khiêm nhường ngữ của làm cho ai việc gì | `V-て + 差し上げる` | Thể hiện hành động làm việc tốt cho đối phương dưới góc độ khiêm tốn, lịch sự tối đa. |
| 121 | **[～～まいる / ～お目にかかる](#6-động-từ-khiêm-nhường-ngữ-đặc-biệt-khác)** | Các khiêm nhường ngữ đặc biệt nâng cao | `まいる / お目にかかる / 伺う / 拝聴する` | Thay thế các hành động thông thường (đi, gặp, nghe) khi báo cáo lên cấp trên hoặc khách hàng. |
|  |
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 122 | **[ひいては](#1-ひいては-kéo-theo-đó--và-cũng)** | Kéo theo đó... / Và cũng... | `Câu A + ひいては + Câu B` | Sự việc vế trước lan rộng và ảnh hưởng lớn đến kết quả vế sau (A dẫn đến kết quả B to lớn hơn). |
| 123 | **[ましてや](#2-ましてや-huống-chi-là--nói-gì-đến)** | Huống chi là... / Nói gì đến... | `Mức độ A (tiêu cực) + ましてや + B` | Nhấn mạnh B còn khó/cực đoan hơn A gấp nhiều lần (thường đi với phủ định ở cuối câu). |
| 124 | **[かえって](#3-かえって-ngược-lại--nào-ngờ)** | Ngược lại... / Nào ngờ... | `Đứng đầu câu hoặc trước động từ` | Kết quả thực tế diễn ra hoàn toàn trái ngược với kỳ vọng/hành động ban đầu. |
| 125 | **[いわば](#4-いわば-có-thể-nói-là--ví-như-là)** | Có thể nói là... / Ví như là... | `いわば + N + (のようだ)` | Dùng để so sánh ví von sự vật, hiện tượng một cách sinh động, khái quát. |
| 126 | **[どうやら](#5-どうやら-có-vẻ-như-là--sau-cùng-thì)** | Có vẻ như là... / Cuối cùng thì... | `どうやら + Thể phán đoán (~らしい / ~そうだ)` | Đưa ra suy đoán dựa trên một số bằng chứng, dấu hiệu thực tế mập mờ. |
| 127 | **[さも](#6-さも-như-thể-là--thực-sự)** | Như thể là... | `さも + V-て / A + (そうに / ように)` | Chỉ thái độ cố tình làm ra vẻ giống hệt như thế (tương tự như まるで). |
| 128 | **[あえて](#7-あえて-dám--mất-công-làm)** | Dám làm... / Cố tình làm... | `あえて + Động từ` | Cố tình làm một việc dù biết là khó khăn, nguy hiểm hoặc gây phiền toái. |
| 129 | **[まさしく](#8-まさしく-chắc-chắn-là--đích-thị-là)** | Chắc chắn là... / Đích thị là... | `まさしく + N + だ / Thể khẳng định` | Khẳng định tuyệt đối, không nghi ngờ gì về sự thật (tương đương với まさに). |
|  |
...
| # | Ngữ pháp | Ý nghĩa tiếng Việt | Cấu trúc kết nối | Sắc thái / Bối cảnh sử dụng |
| :---: | :--- | :--- | :--- | :--- |
| 139 | **[～んがために](#1-んがために-để-nhằm-mục-đích)** | Để nhằm mục đích... | `V-ない (bỏ ない) + んがために`<br>*(する → せんがために)* | Quyết tâm cực kỳ cao độ, sẵn sàng hy sinh để đạt được mục tiêu lớn lao ở vế trước. |
| 140 | **[～んとする](#2-んとする-sắp-sửa--định-làm-gì)** | Sắp sửa... / Định làm gì... | `V-ý chí + とする` | Mô tả sự việc, hiện tượng sắp sửa xảy ra ngay trước mắt (văn phong viết hoặc miêu tả sự vật). |
| 141 | **[～べくして](#3-べくして-đương-nhiên-phải-thế)** | Đương nhiên phải thế | `V-る + べくして + V-た (cùng động từ)` | Khẳng định một kết quả xảy ra là hoàn toàn hợp lý, tất yếu vì đã có các nguyên nhân tích lũy từ trước. |
| 142 | **[～べくもない](#4-べくもない-làm-sao-có-thể--không-thể)** | Làm sao có thể... / Không thể... | `V-る + べくもない`<br>*(する → すべくもない)* | Lập luận logic chỉ ra việc làm vế trước là hoàn toàn bất khả thi, không thể trông đợi gì được. |
| 143 | **[～ともなく](#5-ともなく-không-chủ-định--không-rõ-từ-đâu)** | Vô tình... / Không chủ định | `V-る + ともなく / ともなしに` | Thực hiện hành động một cách vô thức, không tập trung ý chí (ví dụ: vô tình nhìn, vô tình nghe). |
|  |
...
*   **Cấu trúc**: V-る + **べくして** + V-た (cùng một động từ)
